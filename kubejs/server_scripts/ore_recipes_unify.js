...
//板
onEvent('recipes', event => {
    let ingots = ['copper','silver','lead','nickel','uranium','constantan','electrum','steel','aluminum','osmium','tin','zinc','cobalt','bronze','brass','invar','cast_iron','signalum','lumium','enderium','iron','gold','netherite']
    for (let i of ingots) {
    ...
    for (let i of gems) {
        event.remove({output: `#forge:plates/${i}`})
        event.recipes.createPressing([`#forge:plates/${i}`],[`#forge:gems/${i}`])
        event.recipes.thermal.press(`#forge:plates/${i}`,`#forge:gems/${i}`)
        event.recipes.immersiveengineeringMetalPress(`#forge:plates/${i}`, `#forge:gems/${i}`, 'immersiveengineering:mold_plate')
    }
})
...
onEvent('recipes', event => {
    ...
    for (let i of ingots) {
        ...
        event.recipes.bloodmagic.alchemytable(`2x emendatusenigmatica:${i}_dust`, [`#forge:ores/${i}`,"#bloodmagic:arc/cuttingfluid"]).syphon(400).ticks(200).upgradeLevel(1)
        event.custom(
            {
                "type": "bloodmagic:arc",
                "input": {
    ...
    event.recipes.bloodmagic.alchemytable(`2x #forge:dusts/netherite`, [`#forge:ingots/netherite`,"#bloodmagic:arc/cuttingfluid"]).syphon(400).ticks(200).upgradeLevel(1)
    event.custom(
            {
                "type": "bloodmagic:arc",
                "input": {
    ...
    event.recipes.bloodmagic.alchemytable(`2x emendatusenigmatica:obsidian_dust`, [`minecraft:obsidian`,"#bloodmagic:arc/cuttingfluid"]).syphon(400).ticks(200).upgradeLevel(1)
    event.custom(
            {
                "type": "bloodmagic:arc",
                "input": {
    ...
    for (let i of ae) {
        ...
        event.recipes.bloodmagic.alchemytable(`2x appliedenergistics2:${i}_dust`, [`#forge:ores/${i}`,"#bloodmagic:arc/cuttingfluid"]).syphon(400).ticks(200).upgradeLevel(1)
        event.custom(
            {
                "type": "bloodmagic:arc",
                "input": {
...
//齿轮
onEvent('recipes', event => {
    let ingots = ['copper','silver','lead','nickel','uranium','constantan','electrum','steel','aluminum','osmium','tin','zinc','cobalt','bronze','brass','invar','cast_iron','signalum','lumium','enderium','netherite']
    for (let i of ingots) {
        event.remove({output: `#forge:gears/${i}`, type: !'minecraft:crafting_shaped'})
        event.recipes.thermal.press(`#forge:gears/${i}`,`#forge:ingots/${i}`,'thermal:press_gear_die')
        event.recipes.immersiveengineeringMetalPress(`#forge:gears/${i}`, `#forge:ingots/${i}`, 'immersiveengineering:mold_gear')
    }

    let gems = ['lapis','diamond','emerald']
    for (let i of gems) {
        event.remove({output: `#forge:gears/${i}`, type: !'minecraft:crafting_shaped'})
        event.recipes.thermal.press(`#forge:gears/${i}`,`#forge:gems/${i}`,'thermal:press_gear_die')
        event.recipes.immersiveengineeringMetalPress(`#forge:gears/${i}`, `#forge:gems/${i}`, 'immersiveengineering:mold_gear')
    }
})
...
onEvent('recipes', event => {
    ...
    for (let i of gems) {
        ...
        event.recipes.immersiveengineeringMetalPress(`#forge:rods/${i}`, `#forge:gems/${i}`, 'immersiveengineering:mold_rod')
    }
})
...
onEvent('recipes', event => {
    ...
    for (let i of materials) {
        ...
        event.recipes.createCrushing(`2x #create:crushed_ores/${i}` ,`#forge:clusters/${i}`)
    }
})
...
onEvent('recipes', event => {
    ...
    let gems = ['lapis','diamond','emerald','quartz','coal','fluorite','cinnabar','apatite','sulfur','potassium_nitrate']
    for (let i of gems) {
...
//残片
onEvent('recipes', event => {
    let materials = ['copper','silver','lead','nickel','uranium','aluminum','osmium','tin','zinc','cobalt','lapis','diamond','emerald','quartz','certus_quartz','charged_certus_quartz','coal','fluorite','cinnabar','apatite','sulfur','potassium_nitrate','redstone']
    for (let i of materials) {
        event.custom(
            {
                "type": "bloodmagic:arc",
...
//沙砾
onEvent('recipes', event => {
    let materials = ['copper','silver','lead','nickel','uranium','aluminum','osmium','tin','zinc','cobalt','lapis','diamond','emerald','quartz','coal','fluorite','cinnabar','apatite','sulfur','potassium_nitrate','redstone']
    for (let i of materials) {
        event.custom(
            {
                "type": "bloodmagic:arc",
