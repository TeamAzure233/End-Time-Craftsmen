...
onEvent('ftbquests.custom_reward.4E7073BC426FDDC1', event => {
...
onEvent('ftbquests.custom_reward.57058864DEB98784', event => {
...
onEvent('ftbquests.custom_reward.4CE0FAEA4640D6C3', event => {
    ...
    event.server.runCommandSilent(`sh_difficulty add "${event.player.name}" 120`)
})
